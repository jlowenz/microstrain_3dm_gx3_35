 ...
 */
bool handle_error(const char* command_name, Byte error_code) {
...
bool handle_message(app_t* app) {
	...
	case AHRS_DATA_SET: {
		...
		app->imu_data.header.frame_id = app->frame_id;
	    
		// Publish to imu topic4
...
int main(int argc, char** argv) {
	...
	nh.param("frame_id", app->frame_id, std::string("imu"));
